...
public class VertexTest {
    ...
    public void testGetAdjVert() {
        ...
        Edge<String, Integer> edge = new Edge<>();
        assertNull(instance.getAdjVert(edge));
    ...
    public void equalsTest() {
        ...
        Vertex<String, Integer> vertex = new Vertex<>(1, null );
        Vertex<String, Integer> other = new Vertex<>(1, "da" );

        vertex.setElement( null );
    ...
    public void equalsTest2 () {
        ...
        Vertex<String, Integer> vertex = new Vertex<>(1, "1" );
        Vertex<String, Integer> other = new Vertex<>(1, "2" );
