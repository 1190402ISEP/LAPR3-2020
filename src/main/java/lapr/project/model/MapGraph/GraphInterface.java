...
public interface GraphInterface<V, E> {
     ...
     * @return the int
     */
// Returns the number of vertices of the MapGraph
    int numVertices();
     ...
     * @return the iterable
     */
// Returns all the vertices of the MapGraph as an iterable collection
    Iterable<V> vertices();
     ...
     * @return the int
     */
// Returns the number of edges of the MapGraph
    int numEdges();
     ...
     * @return the iterable
     */
// Returns the information of all the edges of the MapGraph as an iterable collection
     ...
     * If the MapGraph is directed, the first vertex is the origin, and
     * the second is the destination.  If the MapGraph is undirected, the
     * order is arbitrary.
     * @param e
     ...
     * For an undirected MapGraph, this is the same result returned by inDegree
     *
     * @param vert the vert
     ...
     * For an undirected MapGraph, this is the same result returned by outDegree
     *
     * @param vert the vert
     * @return number of edges leaving vertex v, -1 if vertex doesn't exist
     */
     ...
     * for an undirected MapGraph, this is the same result returned by incomingEdges
     * @param v
     ...
     * For an undirected MapGraph this is the same result as returned by incomingEdges
     * @param v
     ...
     * specific comparable type. If vertices u, v don't exist in the MapGraph they
     * are inserted
     ...
     * @return the boolean
     */
    /* Removes a vertex and all its incident edges from the MapGraph
